...
public class CommonUtils {
	...
	public static String getUniqLabel() {
		...
		buffer.append(javaName).append('_').append(nSecs).append('_')
				.append(counter.incrementAndGet());
		String uniq = buffer.toString();
	...
	public static String getStackTrace(Throwable aThrowable) {
		...
		String msg = aThrowable.getMessage() + " : " + result.toString();
	...
	public static Object fileToObject(File file) {
		...
		try {
			...
			String message = "FileToObject: IOException on object file read "
					+ e;
			logger.error(message, e);
			throw new RuntimeException(message);
		} catch (ClassNotFoundException e) {
			String message = "FileToObject: Class not found on object file read "
					+ e;
			logger.error(message, e);
			throw new RuntimeException(message);
		}
